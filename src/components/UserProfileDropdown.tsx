...
export default function UserProfileDropdown({ user }: UserProfileDropdownProps) {
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            >
                {/* Avatar */}
                <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-gradient-to-br from-indigo-500 to-indigo-600 flex items-center justify-center text-white font-bold text-xs sm:text-sm shadow-inner">
                    ...
                    >
                        ...
                        <div className="p-4 bg-gradient-to-br from-indigo-50 to-slate-50 border-b border-slate-100">
                            <div className="flex items-center gap-3 mb-3">
                                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-indigo-500 to-indigo-600 flex items-center justify-center text-white font-bold text-lg shadow-lg">
                                    {getInitials(displayName)}
                                </div>
