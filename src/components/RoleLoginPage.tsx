...
export default function GenericLoginPage({ role, title, description, redirectPath }: LoginPageProps) {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // For admin role, construct internal email from 6-digit ID
            if (role === 'admin') {
                loginEmail = `admin${adminId}@parihaaram.admin`;
            }
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <input
                                            ...
                                            required
                                            className="w-full h-12 bg-slate-50/50 border border-slate-200 rounded-xl pl-12 pr-12 text-base font-medium focus:bg-white focus:border-purple-500 focus:ring-4 focus:ring-purple-500/10 outline-none transition-all placeholder:text-slate-400"
                                            placeholder="••••••••"
                                            value={password}
